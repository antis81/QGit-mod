...
void PatchView::buttonFilterPatch_clicked() {
    ...
    PatchContent::PatchFilter filter = pc->filter();
    switch(filter) {
    case PatchContent::VIEW_ALL:
        filter = PatchContent::VIEW_ADDED;
        ic = QString::fromUtf8(":/icons/resources/plusonly.png");
        break;

    case PatchContent::VIEW_ADDED:
        filter = PatchContent::VIEW_REMOVED;
        ic = QString::fromUtf8(":/icons/resources/minusonly.png");
        break;

    case PatchContent::VIEW_REMOVED:
        filter = PatchContent::VIEW_ALL;
        ic = QString::fromUtf8(":/icons/resources/plusminus.png");
        break;
    }
    patchTab->buttonFilterPatch->setIcon(QIcon(ic));
    patchTab->textEditDiff->setFilter(filter);
}
